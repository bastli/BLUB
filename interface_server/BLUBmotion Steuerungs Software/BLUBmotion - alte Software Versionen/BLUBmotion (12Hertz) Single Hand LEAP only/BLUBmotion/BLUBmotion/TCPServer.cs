			...
			while (true)
			{
				...
				switch (msg.ToString())
				{
					...
					case "76": //"L":
                        ...
                        if (clientSleeping)
                        {
                            System.Diagnostics.Debug.WriteLine("[TCP Server] client woke up. ");
					...
					case "86"://"V":
						...
						if (clientSleeping)
						{
							System.Diagnostics.Debug.WriteLine("[TCP Server] client woku up. ");
							clientSleeping = false;
						}
				...
				if (sourcename != null)
				{
                    ...
                    //System.Diagnostics.Debug.WriteLine("[TCP Server] sending telegram. Active=" + telegram.isActive);
				}
